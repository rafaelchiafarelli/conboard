...
#ifndef HARPIA_REST_OUTPUT_ACTION_9f20d5d43738774941f9898b22cf2cf2
#define HARPIA_REST_OUTPUT_ACTION_9f20d5d43738774941f9898b22cf2cf2
...
//   GET    <base>/output_action        list   (?limit=&offset= to paginate)
...
// output_action declares a "pagination[size]" field (its size becomes the default
...
// the request must carry X-User: output_action and X-Pswd: 9f20d5d43738774941f9898b22cf2cf2, or it is rejected
...
inline bool authorized_output_action(const crow::request& req) {
    return req.get_header_value("X-User") == "output_action" &&
           req.get_header_value("X-Pswd") == "9f20d5d43738774941f9898b22cf2cf2";
}
...
#endif  // HARPIA_REST_OUTPUT_ACTION_9f20d5d43738774941f9898b22cf2cf2
