...
#ifndef HARPIA_REST_OUTPUT_ACTION_5a67e5f27cce34a1ec5ac267a70f5d87
#define HARPIA_REST_OUTPUT_ACTION_5a67e5f27cce34a1ec5ac267a70f5d87
...
// the request must carry X-User: output_action and X-Pswd: 5a67e5f27cce34a1ec5ac267a70f5d87, or it is rejected
...
inline bool authorized_output_action(const crow::request& req) {
    return req.get_header_value("X-User") == "output_action" &&
           req.get_header_value("X-Pswd") == "5a67e5f27cce34a1ec5ac267a70f5d87";
}
...
#endif  // HARPIA_REST_OUTPUT_ACTION_5a67e5f27cce34a1ec5ac267a70f5d87
