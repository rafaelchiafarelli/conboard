...
#ifndef HARPIA_REST_OUTPUT_ACTION_b13f689a5b6f99919ddaf4d1cc7eb7ac
#define HARPIA_REST_OUTPUT_ACTION_b13f689a5b6f99919ddaf4d1cc7eb7ac
...
// the request must carry X-User: output_action and X-Pswd: b13f689a5b6f99919ddaf4d1cc7eb7ac, or it is rejected
...
inline bool authorized_output_action(const crow::request& req) {
    return req.get_header_value("X-User") == "output_action" &&
           req.get_header_value("X-Pswd") == "b13f689a5b6f99919ddaf4d1cc7eb7ac";
}
...
#endif  // HARPIA_REST_OUTPUT_ACTION_b13f689a5b6f99919ddaf4d1cc7eb7ac
