...
#ifndef HARPIA_MIGRATE_MODE_7fb7af9d1e69abe2d7a6e81c4a2d0c2f
#define HARPIA_MIGRATE_MODE_7fb7af9d1e69abe2d7a6e81c4a2d0c2f
...
inline bool migrate_mode(::soci::session& db,
    ...
    try {
        ...
        if (!have.count("STATUS_7fb7af9d1e69abe2d7a6e81c4a2d0c2f")) {
            db << "ALTER TABLE \"mode_table\" ADD COLUMN \"STATUS_7fb7af9d1e69abe2d7a6e81c4a2d0c2f\" TEXT;";
        }
        if (!have.count("ERROR_7fb7af9d1e69abe2d7a6e81c4a2d0c2f")) {
            db << "ALTER TABLE \"mode_table\" ADD COLUMN \"ERROR_7fb7af9d1e69abe2d7a6e81c4a2d0c2f\" TEXT;";
        }
        if (!have.count("ORIGINATOR_7fb7af9d1e69abe2d7a6e81c4a2d0c2f")) {
            db << "ALTER TABLE \"mode_table\" ADD COLUMN \"ORIGINATOR_7fb7af9d1e69abe2d7a6e81c4a2d0c2f\" TEXT;";
        }
        ...
        {
            static const std::set<std::string> _current = { "ID_7fb7af9d1e69abe2d7a6e81c4a2d0c2f", "mode_id", "active", "STATUS_7fb7af9d1e69abe2d7a6e81c4a2d0c2f", "ERROR_7fb7af9d1e69abe2d7a6e81c4a2d0c2f", "ORIGINATOR_7fb7af9d1e69abe2d7a6e81c4a2d0c2f" };
        ...
        if (_needs_retype) {
            db << "CREATE TABLE \"mode_table__retype_tmp\" (\"ID_7fb7af9d1e69abe2d7a6e81c4a2d0c2f\" INTEGER PRIMARY KEY, \"mode_id\" INTEGER, \"active\" INTEGER, \"STATUS_7fb7af9d1e69abe2d7a6e81c4a2d0c2f\" TEXT, \"ERROR_7fb7af9d1e69abe2d7a6e81c4a2d0c2f\" TEXT, \"ORIGINATOR_7fb7af9d1e69abe2d7a6e81c4a2d0c2f\" TEXT);";
            db << "INSERT INTO \"mode_table__retype_tmp\" (\"ID_7fb7af9d1e69abe2d7a6e81c4a2d0c2f\", \"mode_id\", \"active\", \"STATUS_7fb7af9d1e69abe2d7a6e81c4a2d0c2f\", \"ERROR_7fb7af9d1e69abe2d7a6e81c4a2d0c2f\", \"ORIGINATOR_7fb7af9d1e69abe2d7a6e81c4a2d0c2f\") SELECT CAST(\"ID_7fb7af9d1e69abe2d7a6e81c4a2d0c2f\" AS INTEGER), CAST(\"mode_id\" AS INTEGER), CAST(\"active\" AS INTEGER), CAST(\"STATUS_7fb7af9d1e69abe2d7a6e81c4a2d0c2f\" AS TEXT), CAST(\"ERROR_7fb7af9d1e69abe2d7a6e81c4a2d0c2f\" AS TEXT), CAST(\"ORIGINATOR_7fb7af9d1e69abe2d7a6e81c4a2d0c2f\" AS TEXT) FROM \"mode_table\";";
            db << "DROP TABLE \"mode_table\";";
            db << "ALTER TABLE \"mode_table__retype_tmp\" RENAME TO \"mode_table\";";
        }
        }
        // stamp the current version
        db << "INSERT OR REPLACE INTO \"_harpia_schema_version\" (\"name\", \"version\") VALUES ('mode_table', '7fb7af9d1e69abe2d7a6e81c4a2d0c2f');";
        return true;
    } catch (const std::exception&) { return false; }
}

// The version hash this migration targets.
inline const char* version_mode() { return "7fb7af9d1e69abe2d7a6e81c4a2d0c2f"; }

}  // namespace db
}  // namespace harpia

#endif  // HARPIA_MIGRATE_MODE_7fb7af9d1e69abe2d7a6e81c4a2d0c2f
