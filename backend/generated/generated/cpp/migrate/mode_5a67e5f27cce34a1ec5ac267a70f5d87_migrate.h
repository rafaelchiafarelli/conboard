...
#ifndef HARPIA_MIGRATE_MODE_5a67e5f27cce34a1ec5ac267a70f5d87
#define HARPIA_MIGRATE_MODE_5a67e5f27cce34a1ec5ac267a70f5d87
...
// idempotent (e.g. guard with a WHERE clause) since migrate_mode may run
// on every startup.
//
...
inline bool migrate_mode(::soci::session& db,
    ...
    try {
        ...
        if (!have.count("name")) {
            db << "ALTER TABLE \"mode_table\" ADD COLUMN \"name\" TEXT;";
        }
        if (!have.count("STATUS_5a67e5f27cce34a1ec5ac267a70f5d87")) {
            db << "ALTER TABLE \"mode_table\" ADD COLUMN \"STATUS_5a67e5f27cce34a1ec5ac267a70f5d87\" TEXT;";
        }
        if (!have.count("ERROR_5a67e5f27cce34a1ec5ac267a70f5d87")) {
            db << "ALTER TABLE \"mode_table\" ADD COLUMN \"ERROR_5a67e5f27cce34a1ec5ac267a70f5d87\" TEXT;";
        }
        if (!have.count("ORIGINATOR_5a67e5f27cce34a1ec5ac267a70f5d87")) {
            db << "ALTER TABLE \"mode_table\" ADD COLUMN \"ORIGINATOR_5a67e5f27cce34a1ec5ac267a70f5d87\" TEXT;";
        }
        ...
        {
            static const std::set<std::string> _current = { "ID_5a67e5f27cce34a1ec5ac267a70f5d87", "mode_id", "active", "name", "STATUS_5a67e5f27cce34a1ec5ac267a70f5d87", "ERROR_5a67e5f27cce34a1ec5ac267a70f5d87", "ORIGINATOR_5a67e5f27cce34a1ec5ac267a70f5d87" };
        ...
        if (_needs_retype) {
            db << "CREATE TABLE \"mode_table__retype_tmp\" (\"ID_5a67e5f27cce34a1ec5ac267a70f5d87\" INTEGER PRIMARY KEY, \"mode_id\" INTEGER, \"active\" INTEGER, \"name\" TEXT, \"STATUS_5a67e5f27cce34a1ec5ac267a70f5d87\" TEXT, \"ERROR_5a67e5f27cce34a1ec5ac267a70f5d87\" TEXT, \"ORIGINATOR_5a67e5f27cce34a1ec5ac267a70f5d87\" TEXT);";
            db << "INSERT INTO \"mode_table__retype_tmp\" (\"ID_5a67e5f27cce34a1ec5ac267a70f5d87\", \"mode_id\", \"active\", \"name\", \"STATUS_5a67e5f27cce34a1ec5ac267a70f5d87\", \"ERROR_5a67e5f27cce34a1ec5ac267a70f5d87\", \"ORIGINATOR_5a67e5f27cce34a1ec5ac267a70f5d87\") SELECT CAST(\"ID_5a67e5f27cce34a1ec5ac267a70f5d87\" AS INTEGER), CAST(\"mode_id\" AS INTEGER), CAST(\"active\" AS INTEGER), CAST(\"name\" AS TEXT), CAST(\"STATUS_5a67e5f27cce34a1ec5ac267a70f5d87\" AS TEXT), CAST(\"ERROR_5a67e5f27cce34a1ec5ac267a70f5d87\" AS TEXT), CAST(\"ORIGINATOR_5a67e5f27cce34a1ec5ac267a70f5d87\" AS TEXT) FROM \"mode_table\";";
            db << "DROP TABLE \"mode_table\";";
            db << "ALTER TABLE \"mode_table__retype_tmp\" RENAME TO \"mode_table\";";
        }
        }
        // stamp the current version
        db << "INSERT OR REPLACE INTO \"_harpia_schema_version\" (\"name\", \"version\") VALUES ('mode_table', '5a67e5f27cce34a1ec5ac267a70f5d87');";
        return true;
    } catch (const std::exception&) { return false; }
}

// The version hash this migration targets.
inline const char* version_mode() { return "5a67e5f27cce34a1ec5ac267a70f5d87"; }

}  // namespace db
}  // namespace harpia

#endif  // HARPIA_MIGRATE_MODE_5a67e5f27cce34a1ec5ac267a70f5d87
