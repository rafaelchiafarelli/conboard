...
#ifndef HARPIA_SOAP_OUTPUT_ACTION_b13f689a5b6f99919ddaf4d1cc7eb7ac
#define HARPIA_SOAP_OUTPUT_ACTION_b13f689a5b6f99919ddaf4d1cc7eb7ac
...
#include "xml/output_action_b13f689a5b6f99919ddaf4d1cc7eb7ac_xml.h"   // brings tinyxml2 + the XML runtime
...
//   <soap:Header><credentials><user>output_action</user><pswd>b13f689a5b6f99919ddaf4d1cc7eb7ac</pswd></credentials></soap:Header>
...
inline bool authorized_output_action(const ::tinyxml2::XMLDocument& doc) {
    ...
    return ::harpia::soap::detail::child_text(cred, "user") == "output_action" &&
           ::harpia::soap::detail::child_text(cred, "pswd") == "b13f689a5b6f99919ddaf4d1cc7eb7ac";
}
...
#endif  // HARPIA_SOAP_OUTPUT_ACTION_b13f689a5b6f99919ddaf4d1cc7eb7ac
