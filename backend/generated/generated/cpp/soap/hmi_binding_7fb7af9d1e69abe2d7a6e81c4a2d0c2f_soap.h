...
#ifndef HARPIA_SOAP_HMI_BINDING_7fb7af9d1e69abe2d7a6e81c4a2d0c2f
#define HARPIA_SOAP_HMI_BINDING_7fb7af9d1e69abe2d7a6e81c4a2d0c2f
...
#include "xml/hmi_binding_7fb7af9d1e69abe2d7a6e81c4a2d0c2f_xml.h"   // brings tinyxml2 + the XML runtime

// Minimal SOAP-over-HTTP access for hmi_binding, backed by the CRUDL DAO. Register on
// a crow::SimpleApp with a base path; POST a SOAP envelope to <base>/hmi_binding:
//   <soap:Body><get><id>N</id></get></soap:Body>          -> the hmi_binding as XML
//   <soap:Body><set><hmi_binding>...</hmi_binding></set></soap:Body>       -> create
//   <soap:Body><update><hmi_binding>...</hmi_binding></update></soap:Body> -> update
...
//   <soap:Header><credentials><user>hmi_binding</user><pswd>7fb7af9d1e69abe2d7a6e81c4a2d0c2f</pswd></credentials></soap:Header>
...
inline std::string envelope_hmi_binding(const std::string& body) {
    return "<?xml version=\"1.0\"?>"
           "<soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"
           "<soap:Body>" + body + "</soap:Body></soap:Envelope>";
}

// True iff the envelope carries the correct credential for hmi_binding. The handler
// gates every operation on this; exposed so it can be unit-tested directly.
inline bool authorized_hmi_binding(const ::tinyxml2::XMLDocument& doc) {
    ...
    return ::harpia::soap::detail::child_text(cred, "user") == "hmi_binding" &&
           ::harpia::soap::detail::child_text(cred, "pswd") == "7fb7af9d1e69abe2d7a6e81c4a2d0c2f";
}

inline bool authorized_hmi_binding(const std::string& soap_xml) {
    ::tinyxml2::XMLDocument doc;
    if (doc.Parse(soap_xml.c_str()) != ::tinyxml2::XML_SUCCESS) return false;
    return authorized_hmi_binding(doc);
}

inline void register_hmi_binding_soap(crow::SimpleApp& app, ::soci::session& db,
    ...
    ::soci::session* dbp = &db;
    app.route_dynamic(base + "/hmi_binding").methods(crow::HTTPMethod::POST)(
        ...
        if (!authorized_hmi_binding(doc)) {
            res.code = 401;
            reply(envelope_hmi_binding(
        ...
        if (name == "get") {
            ...
            const auto* m = op->FirstChildElement();          // the hmi_binding element
            ::hmi_binding msg;
...
#endif  // HARPIA_SOAP_HMI_BINDING_7fb7af9d1e69abe2d7a6e81c4a2d0c2f
