...
#ifndef HARPIA_ZMQ_OUTPUT_ACTION_5a67e5f27cce34a1ec5ac267a70f5d87
#define HARPIA_ZMQ_OUTPUT_ACTION_5a67e5f27cce34a1ec5ac267a70f5d87
...
// with no client certs). Guarded separately from the per-message HARPIA_ZMQ_OUTPUT_ACTION_5a67e5f27cce34a1ec5ac267a70f5d87 so
...
public:
    ...
    static const std::string& origin_id() {
        static const std::string id = "1001488767176491670";
        return id;
    }
    const std::string& origin() const { return origin_; }
    bool send(const ::output_action& msg) {
        ::output_action stamped = msg;
        stamped.set_originator_5a67e5f27cce34a1ec5ac267a70f5d87(origin_);
        std::string bytes;
...
#endif  // HARPIA_ZMQ_OUTPUT_ACTION_5a67e5f27cce34a1ec5ac267a70f5d87
