...
#ifndef HARPIA_ZMQ_OUTPUT_ACTION_b13f689a5b6f99919ddaf4d1cc7eb7ac
#define HARPIA_ZMQ_OUTPUT_ACTION_b13f689a5b6f99919ddaf4d1cc7eb7ac
...
// with no client certs). Guarded separately from the per-message HARPIA_ZMQ_OUTPUT_ACTION_b13f689a5b6f99919ddaf4d1cc7eb7ac so
...
public:
    ...
    static const std::string& origin_id() {
        static const std::string id = "257127316357638190";
        return id;
    }
    const std::string& origin() const { return origin_; }
    bool send(const ::output_action& msg) {
        ::output_action stamped = msg;
        stamped.set_originator_b13f689a5b6f99919ddaf4d1cc7eb7ac(origin_);
        std::string bytes;
...
#endif  // HARPIA_ZMQ_OUTPUT_ACTION_b13f689a5b6f99919ddaf4d1cc7eb7ac
