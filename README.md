...
* keyboard / mouse (input) — HARDWARE-VERIFIED
    ...
    * starter profiles: `boards/Xbox360.json` (joystick), `boards/WirelessKB.json` / `boards/WirelessMouse.json` (keyboard/mouse — add a new device like those)
* joystick (input) — BUILT, pending hardware test
    * same `EvdevDevice`/`conJoyS` stack as above; no gamepad was available to exercise it yet
